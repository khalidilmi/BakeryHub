  ...
  const handleAddHour = async () => {
    try {
      ...
      if (res.ok) {
        ...
        setNewHour({ bakerId: 1, dayOfWeek: '', openingTime: '', closingTime: '' });
      } else {
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => setNewHour({ ...newHour, openingTime: e.target.value })}
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={(e) => setNewHour({ ...newHour, closingTime: e.target.value })}
              />
            </div>
